...
score is:
    ...
    100 - tracking(temp/level) - excess-energy - safety
...
class KPIScorer:
    def __init__(self, model):
        ...
        self.l_div = float(getattr(model, "kpi_level_scale", 1.0))
    ...
    def step_penalty(self, levels, temps, h_sp, t_sp, heat_w, ideal_w, interlock, dt):
        """Accumulate one control step and return the instantaneous KPI penalty."""
    ...
    def report(self):
        ...
        return {
            "score": score,
            "avg_temp_err": avgT,
            "avg_level_err_cm": avgL * 100.0,
            "excess_kwh": self.excess,
            "interlock_frac": sFrac,
            "comp_temp": pT,
            "comp_level": pL,
            "comp_energy": pE,
            "comp_safety": pS,
